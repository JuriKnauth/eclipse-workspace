...
public class Vertex4D {
	...
	//
	public static Vertex4D normal2(Vertex4D n) {
	...
	public static Vertex4D plus(Vertex4D v0, Vertex4D v1) {
		return new Vertex4D(v0.x + v1.x, v0.y + v1.y, v0.z + v1.z);
	}
	...
	public static Vertex4D smult(double a, Vertex4D v) {
		return new Vertex4D(a*v.x, a*v.y, a*v.z);
	}
	
	public static Vertex4D reflect(Vertex4D l, Vertex4D n) {
		return Vertex4D.minus(l, Vertex4D.smult(2*Vertex4D.dot(l,n),n));
	}

	public static Vertex4D negate(Vertex4D u) {
		return new Vertex4D(-u.x, -u.y, -u.z); 
	}
